...
class ReportActivity : AppCompatActivity() {
    ...
    private fun setupButtons() {
        binding.exportPdfButton.setOnClickListener {
            // PDF export with iText7 integration coming in v5.3
            Toast.makeText(this, "PDF export coming in v5.3 - Use Share for now", Toast.LENGTH_SHORT).show()
        }
    ...
    private fun shareReport() {
        val shareText = buildString {
            ...
            appendLine("Generated by Verum Omnis Forensic Engine v${com.veruomnis.forensic.ForensicApplication.VERSION}")
        }
